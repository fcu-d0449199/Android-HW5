...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nbaItems.add(new NBAitem(R.drawable.grizzlies, "Grizzlies", 95, R.drawable.spurs, "Suprs", 116));
        nbaItems.add(new NBAitem(R.drawable.rockets, "Rockets", 94, R.drawable.warriors, "Warriors", 121));
